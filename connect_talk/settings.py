...
# Render (e serviços parecidos) atribuem o hostname público em tempo de deploy —
# reconhece automaticamente em vez de exigir configurar DJANGO_ALLOWED_HOSTS na mão.
